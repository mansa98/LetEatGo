...
import com.mbc.leteatgo.service.CustomProvider;
...
//						                .requestMatchers("/member/hasFld/**").permitAll().requestMatchers("/member/view.do", "/member/hasFldForUpdate/**").authenticated()
//						                .requestMatchers("/member/view.do", "/member/hasFldForUpdate/**").authenticated()
						                ...
						                .requestMatchers("/recomm/getRecomm").authenticated()
						                .requestMatchers("/recipe/raiseLike", "/recipe/decreaseLike").authenticated()
