...
import com.student.login.domain.Role;
import com.student.login.domain.MemberDTO;
import com.student.login.mapper.MemberMapper;
	 ...
	 // 닉네임 중복 체크 메서드
		...
		public boolean insertMemberRole(MemberDTO memberDTO) {
			...
			try {
	            ...
	            // 롤 삽입
	            Role role = new Role();
	            role.setUsername(memberDTO.getMemberId());
	            role.setRole("ROLE_USER"); // 새로운 사용자에 대한 기본 롤
